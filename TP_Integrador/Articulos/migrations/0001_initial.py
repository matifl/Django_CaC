# Generated by Django 4.0.6 on 2022-10-24 13:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagen_url', models.ImageField(upload_to='articulos', verbose_name='Imagen')),
            ],
        ),
        migrations.CreateModel(
            name='Categoria',
        ...
        migrations.CreateModel(
            name='Subcategoria',
            fields=[
                ('id_subcategoria', models.TextField(max_length=10, primary_key=True, serialize=False, verbose_name='Descripción Subcategoría')),
